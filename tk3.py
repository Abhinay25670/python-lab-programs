...
countries = ['USA', 'Canada', 'UK', 'Australia', 'Germany']  # Example country names
selected_country = StringVar(value=countries[0])
country_dropdown = OptionMenu(form_frame, selected_country, *countries)
country_dropdown.grid(row=8, column=1, padx=5, sticky="w")
# Button widget
